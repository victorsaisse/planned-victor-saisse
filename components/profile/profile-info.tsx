  ...
  return (
    <Fragment>
      ...
      <div className="md:pl-[200px] pt-[100px] items-center md:items-start md:pt-2 flex flex-col gap-1 ">
        <h1 className="text-2xl font-bold flex items-center gap-2 max-w-[90%]">
          <span className="md:max-w-[80%] md:truncate">{profile.name}</span>
          <EditButton
        ...
        <div className="flex flex-col gap-1 w-full ">
          <p className="text-gray-500 text-sm max-md:text-center md:max-w-[80%] md:truncate">
            {profile.bio}
          </p>
          <p className="flex items-center gap-1 max-md:justify-center">
            <MapPin size={16} className="text-gray-500" />
            <span className="text-gray-500 text-sm max-md:text-center md:max-w-[80%] md:truncate">
              {profile.location}
            </span>
          </p>
        </div>
